...
class _CircularSliderState extends State<CircularSliderPaint> {
  ...
  Offset get startPos => getStartOffset();
  Offset getStartOffset() {
    Offset center = Offset(widget.width / 2, widget.height / 2);
    double radius = math.min(widget.width / 2, widget.height / 2) - widget.sliderStrokeWidth;
    return radiansToCoordinates(center, -math.pi / 2 + _startAngle, radius);
  }

  Offset get endPos => getEndOffset();
  Offset getEndOffset() {
    Offset center = Offset(widget.width / 2, widget.height / 2);
    double radius = math.min(widget.width / 2, widget.height / 2) - widget.sliderStrokeWidth;
    return radiansToCoordinates(center, -math.pi / 2 + _endAngle, radius);
  }
      ...
      child: SizedBox(
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              top: startPos.dy - widget.sliderStrokeWidth / 2,
              left: startPos.dx - widget.sliderStrokeWidth / 2,
              child: widget.startWidget ?? Container(),
            ),
            Positioned(
              top: endPos.dy - widget.sliderStrokeWidth / 2,
              left: endPos.dx - widget.sliderStrokeWidth / 2,
              child: widget.endWidget ?? Container(),
            ),
          ],
        ),
      ),
